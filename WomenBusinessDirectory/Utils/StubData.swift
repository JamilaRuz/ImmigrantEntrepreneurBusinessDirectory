...
@MainActor func createPreviewModelContainer() -> ModelContainer {
  ...
  do {
    ...
    companiesFromDb[0].entrepreneurs = [entrepreneursFromDb[0], entrepreneursFromDb[1]]
    companiesFromDb[1].entrepreneurs = [entrepreneursFromDb[0]]
...
func createStubCompanies() -> [Company] {
  ...
  let company3 = Company(name: "Company name three", logoImg: "comp_logo3", aboutUs: "Our company was fouded 10 years ago. It mainly focuses on software development. Our....", dateFounded: "10/13/2006", entrepreneurs: [], address: "123 Bank street", phoneNum: "123456", email: "test@gmail.com", workHours: "Mon 9 - 5, Tue 9 - 5, Wed 9 - 5, Thu 9 - 5, Fri 9 - 5, ", directions: "Near the pharmacy", category: Category(name: "Beauty", image: "health"), isFavorite: false
  )
  
  let company4 = Company(name: "Company name four", logoImg: "comp_logo4", aboutUs: "Our company was fouded 10 years ago. It mainly focuses on software development. Our....", dateFounded: "10/13/2006", entrepreneurs: [], address: "123 Bank street", phoneNum: "123456", email: "test@gmail.com", workHours: "Mon-Fri 9 - 5", directions: "Near the pharmacy", category: Category(name: "Beauty", image: "health"), isFavorite: false
  )
